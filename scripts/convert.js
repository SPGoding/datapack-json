...
const registriesJson = JSON.parse(fs.readFileSync(path.join(__dirname, './registries.json'), { encoding: 'utf8' }))
...
function convert(keyName, fileName) {
    ...
    fs.writeFileSync(path.join(__dirname, `../java/shared/${fileName}.json`), JSON.stringify(ans, undefined, 4))
}
